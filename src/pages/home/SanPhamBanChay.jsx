...
import { callGetTop4BestSale } from "../../services/api";
...
const SanPhamBanChay = (props) => {
  ...
  const handleGetlistTop4ProdBestOfSales = async () => {
    const res = await callGetTop4BestSale();
    if (res?.status === 0) {
  ...
  useEffect(() => {
    handleGetlistTop4ProdBestOfSales();
  }, []);
